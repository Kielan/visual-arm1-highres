...
function updateFromKeyFlags() {
    if (keyFlags != 0) {
        var dlt = 0.002 * eyeVec3[2] + 0.0004;
...
function downloadMsg(inc) {
    ...
    replaceInner('msg', 'Downloaded ' + (numDownloads - numActiveDownloads) +
...
function render() {
    ...
    if (!loaded) {
        ...
        if (layerDoneCount == layerReqs.length &&
            ...
            replaceInner('msg', 'Downloads complete, version ' + version + '<br>');
            addInner('msg', '&copy <a href="http://visual6502.org">Visual6502.org</a><br>');
            addInner('msg', 'ARM1 geometry provided under EULA with ' +
                     '<a href="http://www.arm.com">ARM Ltd.</a>, UK<br>');
            addInner('msg', '<br>');
            addInner('msg', '<a href="http://blog.visual6502.org">Blog</a><br><br>');
            addInner('msg', 'Like this?  Consider a <a href="http://visual6502.org/donate_cash.html">donation</a><br>');
